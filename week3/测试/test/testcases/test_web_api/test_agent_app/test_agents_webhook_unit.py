...
def test_webhook_token_basic_jwt_auth(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        _DummyRequest(
            ...
            json_body={},
            authorization=SimpleNamespace(username="u", password=""<REDACTED>"),
        ),
    )
    basic_security = {"auth_type": "basic", "basic_auth": {"username": "u", "password": ""<REDACTED>"}}
    ...
    monkeypatch.setattr(
        module,
        "request",
        _DummyRequest(headers={"Content-Type": "application/json", "Authorization": ""<REDACTED>"}, json_body={}),
    )
