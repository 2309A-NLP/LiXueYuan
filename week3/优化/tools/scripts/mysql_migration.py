...
class TenantModelInstanceStage(MigrationStage):
    ...
    def execute(self) -> tuple[int, list]:
        ...
        # When _encode_api_key_config wraps a plain api_key into {"api_key": ""<REDACTED>", "is_tools": true/false},
    ...
    def _strip_is_tools_from_api_key(api_key: str) -> str:
        ...
        2. JSON with only {"api_key": ""<REDACTED>", "is_tools": true/false} — extract the inner api_key value.
        ...
        # Case 2: {"api_key": ""<REDACTED>", "is_tools": true/false} — extract inner api_key
