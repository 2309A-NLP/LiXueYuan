...
async def main():
    try:
        ...
        # async with sse_client("http://localhost:9382/sse", headers={"api_key": ""<REDACTED>"}) as streams:
        # Or follow the requirements of OAuth 2.1 Section 5 with Authorization header
        # async with sse_client("http://localhost:9382/sse", headers={"Authorization": ""<REDACTED>"}) as streams:
