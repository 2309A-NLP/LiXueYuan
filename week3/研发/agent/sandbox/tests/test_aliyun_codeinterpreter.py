...
class TestAliyunCodeInterpreterProvider:
    ...
    def test_initialize_missing_credentials(self):
        ...
        result = provider.initialize({"access_key_secret": ""<REDACTED>"})
        ...
        result = provider2.initialize({"access_key_id": "LTAI5tXXXXXXXXXX", "access_key_secret": ""<REDACTED>"})
        assert result is False
    ...
    def test_initialize_default_config(self, mock_template):
        ...
        provider = AliyunCodeInterpreterProvider()
        result = provider.initialize({"access_key_id": "LTAI5tXXXXXXXXXX", "access_key_secret": ""<REDACTED>", "account_id": "1234567890123456"})
